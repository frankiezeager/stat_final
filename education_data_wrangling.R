...
reading %>% group_by(DIV_NAME)%>% summarise(reading.AVG_SOL_SCALE_SCORE=mean(AVG_SOL_SCALE_SCORE),
                                            ...
                                            reading.FAIL_RATE=mean(FAIL_RATE), reading.num_female=sum(gender_dummy_F), reading.num_frc_3=sum(federal_race_code_3,na.rm=TRUE), reading.num_frc_4=sum(federal_race_code_4,na.rm=TRUE),
                                            reading.num_frc_5=sum(federal_race_code_5,na.rm=TRUE), reading.num_frc_NA=sum(federal_race_code_NA,na.rm=TRUE), reading.num_frc_99=sum(federal_race_code_99,na.rm=TRUE), reading.num_frc_2=sum(federal_race_code_2,na.rm=TRUE),
                                            reading.num_frc_1=sum(federal_race_code_1,na.rm=TRUE),reading.num_frc_6=sum(federal_race_code_6,na.rm=TRUE), reading.disability_flag=sum(disability_flag_Y),reading.lep_flag=sum(lep_flag_Y),
                                            reading.disadvantaged_flag=sum(disadvantaged_flag_Y))->reading.grouped
...
writing %>% group_by(DIV_NAME)%>% summarise(writing.AVG_SOL_SCALE_SCORE=mean(AVG_SOL_SCALE_SCORE),
                                            ...
                                            writing.FAIL_RATE=mean(FAIL_RATE), writing.num_female=sum(gender_dummy_F), writing.num_frc_3=sum(federal_race_code_3,na.rm=TRUE), writing.num_frc_4=sum(federal_race_code_4,na.rm=TRUE),
                                            writing.num_frc_5=sum(federal_race_code_5,na.rm=TRUE), writing.num_frc_NA=sum(federal_race_code_NA,na.rm=TRUE), writing.num_frc_99=sum(federal_race_code_99,na.rm=TRUE), writing.num_frc_2=sum(federal_race_code_2,na.rm=TRUE),
                                            writing.num_frc_1=sum(federal_race_code_1,na.rm=TRUE),writing.num_frc_6=sum(federal_race_code_6,na.rm=TRUE), writing.disability_flag=sum(disability_flag_Y),writing.lep_flag=sum(lep_flag_Y),
                                            writing.disadvantaged_flag=sum(disadvantaged_flag_Y))->writing.grouped
...
history %>% group_by(DIV_NAME)%>% summarise(history.AVG_SOL_SCALE_SCORE=mean(AVG_SOL_SCALE_SCORE),
                                            ...
                                            history.FAIL_RATE=mean(FAIL_RATE), history.num_female=sum(gender_dummy_F), history.num_frc_3=sum(federal_race_code_3,na.rm=TRUE), history.num_frc_4=sum(federal_race_code_4,na.rm=TRUE),
                                            history.num_frc_5=sum(federal_race_code_5,na.rm=TRUE), history.num_frc_NA=sum(federal_race_code_NA,na.rm=TRUE), history.num_frc_99=sum(federal_race_code_99,na.rm=TRUE), history.num_frc_2=sum(federal_race_code_2,na.rm=TRUE),
                                            history.num_frc_1=sum(federal_race_code_1,na.rm=TRUE),history.num_frc_6=sum(federal_race_code_6,na.rm=TRUE), history.disability_flag=sum(disability_flag_Y),history.lep_flag=sum(lep_flag_Y),
                                            history.disadvantaged_flag=sum(disadvantaged_flag_Y))->history.grouped
...
math %>% group_by(DIV_NAME)%>% summarise(math.AVG_SOL_SCALE_SCORE=mean(AVG_SOL_SCALE_SCORE),
                                            ...
                                            math.FAIL_RATE=mean(FAIL_RATE), math.num_female=sum(gender_dummy_F), math.num_frc_3=sum(federal_race_code_3,na.rm=TRUE), math.num_frc_4=sum(federal_race_code_4,na.rm=TRUE),
                                            math.num_frc_5=sum(federal_race_code_5,na.rm=TRUE), math.num_frc_NA=sum(federal_race_code_NA,na.rm=TRUE), math.num_frc_99=sum(federal_race_code_99,na.rm=TRUE), math.num_frc_2=sum(federal_race_code_2,na.rm=TRUE),
                                            math.num_frc_1=sum(federal_race_code_1,na.rm=TRUE),math.num_frc_6=sum(federal_race_code_6,na.rm=TRUE), math.disability_flag=sum(disability_flag_Y),math.lep_flag=sum(lep_flag_Y),
                                            math.disadvantaged_flag=sum(disadvantaged_flag_Y))->math.grouped
...
science %>% group_by(DIV_NAME)%>% summarise(science.AVG_SOL_SCALE_SCORE=mean(AVG_SOL_SCALE_SCORE),
                                            ...
                                            science.FAIL_RATE=mean(FAIL_RATE), science.num_female=sum(gender_dummy_F), science.num_frc_3=sum(federal_race_code_3,na.rm=TRUE), science.num_frc_4=sum(federal_race_code_4,na.rm=TRUE),
                                            science.num_frc_5=sum(federal_race_code_5,na.rm=TRUE), science.num_frc_NA=sum(federal_race_code_NA,na.rm=TRUE), science.num_frc_99=sum(federal_race_code_99,na.rm=TRUE), science.num_frc_2=sum(federal_race_code_2,na.rm=TRUE),
                                            science.num_frc_1=sum(federal_race_code_1,na.rm=TRUE),science.num_frc_6=sum(federal_race_code_6,na.rm=TRUE), science.disability_flag=sum(disability_flag_Y),science.lep_flag=sum(lep_flag_Y),
                                            science.disadvantaged_flag=sum(disadvantaged_flag_Y))->science.grouped
